// $Id: support_statistics.java,v 1.10 2008/12/31 23:50:23 cmzmasek Exp $
    ...
    public static void main( final String args[] ) {
        ...
        for( int i = 0; i < phylogenies_infiles.length; i++ ) {
            try {
                ...
                final PhylogenyParser pp = ForesterUtil.createParserDependingOnFileType( phylogenies_infiles[ i ] );
