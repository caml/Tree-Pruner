...
public class JavaBridge implements Runnable {
    ...
    /**
     * The field separator.  When a  script or HTML file
    ...
    /**
     * The row separator.  When a  script or HTML file
     * returns data, then the getParsedData() method will
    ...
    /**
     * The top of data separator.  When a  script or HTML file
     * returns data, then the getParsedData() method will
    ...
    /**
     * The bottom of data separator.  When a  script or HTML file
     * returns data, then the getParsedData() method will
...
     */
     ...
     */
    private String threadData = null;

    /**
     * This is the default  Timeout in milliseconds.  For example,
     * a value of 10000 will tell the class to throw a
     * JavaBridgeTimeOutException if the data is not retrieved within
     * 10 seconds of having initiated a data transfer.
     */
    private static int defaultThreadJavaBridgeTimeOut = 10000;

    /**
     * This is the actual  Timeout value in milliseconds for the
     ...
     * uses.
     */
    private int threadJavaBridgeTimeOut = defaultThreadJavaBridgeTimeOut;
     ...
     */
    public JavaBridge(String field, String row, String top, String bottom) {
     ...
     * @exception JavaBridgeTimeOutException If the retrieval times out
     * @see #getRawData
     */
    public Vector getParsedData(URL u) throws JavaBridgeTimeOutException {
    ...
    public Vector getParsedData(URL u, Hashtable ht) 
      throws JavaBridgeTimeOutException {

        // getParsedData calls getRawData to obtain
        // the actual HTML text
        String data = getRawData(u,ht);
     ...
     * @see #getParsedData
     */
    public String getRawData(URL u) throws JavaBridgeTimeOutException {
     ...
     * @see #getParsedData
     */
    public String getRawData(URL u, Hashtable ht)
      throws JavaBridgeTimeOutException 
    {
        ...
        if (threadCompleted == false) {
            throw new JavaBridgeTimeOutException();
        }
        return threadData;
    }
     ...
     * JavaBridgeTimeOutException is thrown.
     *
     * @return default communication time out in milliseconds
     * @see #setDefaultThreadJavaBridgeTimeOut
     */
    public static int getDefaultThreadJavaBridgeTimeOut() { 
        return defaultThreadJavaBridgeTimeOut; 
    }
     ...
     * @see #getDefaultThreadJavaBridgeTimeOut
     */
    public static void setDefaultThreadJavaBridgeTimeOut(int t) {
        defaultThreadJavaBridgeTimeOut = t;
    }
     ...
     * @see #setThreadJavaBridgeTimeOut
     * @see #getDefaultThreadJavaBridgeTimeOut
     * @see #setDefaultThreadJavaBridgeTimeOut
     */
    public int getThreadJavaBridgeTimeOut() { 
        return threadJavaBridgeTimeOut; 
    }
     ...
     * @see #getThreadJavaBridgeTimeOut
     * @see #getDefaultThreadJavaBridgeTimeOut
     * @see #setDefaultThreadJavaBridgeTimeOut
     */
    public void setThreadJavaBridgeTimeOut(int t) { 
        threadJavaBridgeTimeOut = t; 
    }
     ...
     * a URL and places the contents into the threadData variable.
     *
    ...
    public void run() {
        if (threadCanRunMethodExecute) {
            threadData = getHttpRequestInThread(
     ...
     * URL encoded string of parameters for a  based program
     * to process.
     *
     ...
     * @see #run
     */
    private String getHttpRequestInThread(URL u, Hashtable ht) {   //Method modified to chnage
    															   //from HTTP post to HTTP get //BHB06--09
        ...
        URL HTTPgetURL = null;
        try {
			HTTPgetURL = new  URL(u.toString()+postContent);
		}  catch (MalformedURLException e) {
            System.out.println("Malformed URL Exception:" + e);
		}
		System.out.println("HTTP GET URL from getHttpRequestInThread in JavaBridge\n"+ HTTPgetURL + "\n"); 
       ...
       try {
            ...
            urlConn = HTTPgetURL.openConnection(); //BHB06--09

            // We always want some input from the  script
            ...
            // Send the POST data if we are writing //commented //BHB06--09
          /*  if (ht != null) {
