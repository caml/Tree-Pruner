// $Id: ControlPanel.java,v 1.21 2009/06/15 18:31:33 cmzmasek Exp $
...
//********************************************END**********************************************************//
    ...
    private JCheckBox            _color_orthos;
    private JCheckBox            _color_super_orthos;
    private JCheckBox            _color_s_n;
    ...
    public void actionPerformed( final ActionEvent e ) {
        try {
            ...
            else if ( e.getSource() == _color_orthos ) {
                // turn off the other orthologous options
                setCheckbox( _color_super_orthos, false );
                setCheckbox( _color_s_n, false );
            }
            else if ( e.getSource() == _color_super_orthos ) {
                setCheckbox( _color_orthos, false );
                setCheckbox( _color_s_n, false );
            }
            else if ( e.getSource() == _color_s_n ) {
                setCheckbox( _color_orthos, false );
                setCheckbox( _color_super_orthos, false );
            }
    ...
    void addButtons() {
        ...
        add( spacer );
        final JPanel x_panel = new JPanel( new GridLayout( 1, 3, 0, 0 ) );
        final JPanel y_panel = new JPanel( new GridLayout( 1, 3, 0, 0 ) );
        final JPanel z_panel = new JPanel( new GridLayout( 1, 3, 0, 0 ) );
        ...
        //_zoom_out_y.setPreferredSize( _show_whole.getMinimumSize() );
        _zoom_out_y.setPreferredSize( new Dimension( 10, 10 ) );
        _zoom_in_y.setPreferredSize( _show_whole.getMinimumSize() );
        _zoom_out_x.setPreferredSize( new Dimension( 10, 10 ) );
        _zoom_in_x.setPreferredSize( new Dimension( 10, 10 ) );
        _zoom_out_x.setMaximumSize( new Dimension( 10, 10 ) );
        _zoom_in_x.setMaximumSize( new Dimension( 10, 10 ) );
    ...
    void addCheckbox( final int which, final String title ) {
        ...
        switch ( which ) {
            ...
            case Configuration.width_branches:
                ...
                add( ch_panel );
                break;
            case Configuration.color_orthologous:
                _color_orthos = new JCheckBox( title );
                addJCheckBox( _color_orthos, ch_panel );
                add( ch_panel );
                break;
            case Configuration.color_super_orthologous:
                _color_super_orthos = new JCheckBox( title );
                addJCheckBox( _color_super_orthos, ch_panel );
                add( ch_panel );
                break;
            case Configuration.color_subtree_neighbors:
                _color_s_n = new JCheckBox( title );
                addJCheckBox( _color_s_n, ch_panel );
                add( ch_panel );
                break;
    ...
    boolean isColorOrthologous() {
        return ( ( _color_orthos != null ) && _color_orthos.isSelected() );
    }

    boolean isColorSubtreeNeighbors() {
        return ( ( _color_s_n != null ) && _color_s_n.isSelected() );
    }

    boolean isColorSuperOrthologous() {
        return ( ( _color_super_orthos != null ) && _color_super_orthos.isSelected() );
    }
    ...
    void setCheckbox( final int which, final boolean state ) {
        switch ( which ) {
            ...
            case Configuration.width_branches:
                ...
                break;
            case Configuration.color_orthologous:
                if ( _color_orthos != null ) {
                    _color_orthos.setSelected( state );
                }
                break;
            case Configuration.color_super_orthologous:
                if ( _color_super_orthos != null ) {
                    _color_super_orthos.setSelected( state );
                }
                break;
            case Configuration.color_subtree_neighbors:
                if ( _color_s_n != null ) {
                    _color_s_n.setSelected( state );
                }
                break;
            case Configuration.show_domain_architectures:
    ...
    void setUpControlsForDomainStrucures() {
        ...
        _zoom_in_domain_structure = new JButton( "X+" );
        _zoom_out_domain_structure = new JButton( "X-" );
    ...
    void updateDomainStructureEvaluethresholdDisplay() {
        if ( _domain_structure_evalue_thr_tf != null ) {
            _domain_structure_evalue_thr_tf.setText( "1*10e"
    ...
    void zoomInX( final float factor, final float x_correction_factor ) {
        ...
        if ( ( treepanel.getPhylogenyGraphicsType() == PHYLOGENY_GRAPHICS_TYPE.CIRCULAR )
                ...
                || isDrawPhylogram( _mainpanel.getCurrentTabIndex() ) || getOptions().isNonLinedUpCladogram() ) {
    ...
    private void setupDisplayCheckboxes() {
        ...
        if ( _configuration.doDisplayOption( Configuration.color_orthologous ) ) {
            addCheckbox( Configuration.color_orthologous, _configuration
                    .getDisplayTitle( Configuration.color_orthologous ) );
            setCheckbox( Configuration.color_orthologous, _configuration
                    .doCheckOption( Configuration.color_orthologous ) );
        }
        if ( _configuration.doDisplayOption( Configuration.color_super_orthologous ) ) {
            addCheckbox( Configuration.color_super_orthologous, _configuration
                    .getDisplayTitle( Configuration.color_super_orthologous ) );
            setCheckbox( Configuration.color_super_orthologous, _configuration
                    .doCheckOption( Configuration.color_super_orthologous ) );
        }
        if ( _configuration.doDisplayOption( Configuration.color_subtree_neighbors ) ) {
            addCheckbox( Configuration.color_subtree_neighbors, _configuration
                    .getDisplayTitle( Configuration.color_subtree_neighbors ) );
            setCheckbox( Configuration.color_subtree_neighbors, _configuration
                    .doCheckOption( Configuration.color_subtree_neighbors ) );
        }
    }
