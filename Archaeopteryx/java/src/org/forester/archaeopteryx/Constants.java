// $Id: Constants.java,v 1.25 2009/06/19 16:27:31 cmzmasek Exp $
...
public final class Constants {
    ...
    final static String       VERSION                                   = "0.0.0 alpha 007 \"inky\"";
    final static String       PRG_DATE                                  = "2009.06.19";
    ...
    final static Color        CHECKBOX_TEXT_COLOR_DEFAULT               = new Color( 220, 220, 220 );
    ...
    final static Color        BUTTON_TEXT_COLOR_DEFAULT                 = new Color( 255, 255, 255 );
    ...
    public final static Color DOMAIN_STRUCTURE_FONT_COLOR               = new Color( 150, 140, 130 );
    ...
    final static double       PDF_LINE_WIDTH_DEFAULT                    = 0.5;
    static String             WEB_SITE                                  = "http://www.phylosoft.org/archaeopteryx/";
    final static String       PHYLOXML_WEB_SITE                         = "http://www.phyloxml.org";
}
