// $Id: TaxonomyParser.java,v 1.2 2009/02/13 22:54:04 cmzmasek Exp $
...
public class TaxonomyParser implements PhylogenyDataPhyloXmlParser {
    ...
    public Taxonomy parse( final XmlElement element ) throws PhylogenyParserException {
        ...
        if ( element.isHasAttribute( PhyloXmlMapping.TAXONOMY_TYPE ) ) {
            taxonomy.setType( element.getAttribute( PhyloXmlMapping.TAXONOMY_TYPE ) );
        }
